<h1 align="center"> Smart Manager · Gemini 3.1 AI 기반 커머스 운영 시스템 </h1>
<p align="center">
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/AI-Gemini_3.1_Flash_Lite-4285F4?logo=googlegemini" />
...
<p align="center">
  <b>Gemini 3.1 Flash Lite 모델을 활용한 고속 상품 데이터 자동화 엔진</b><br/>
...
## 🚀 핵심 엔진: Gemini 3.1 Flash Lite 기반 분석
본 시스템은 차세대 **Gemini 3.1 Flash Lite** 모델을 탑재하여 운영 효율을 극대화했습니다.
...
<ul>
  ...
  <li><b>핵심 기술 스택:</b> Filament v5.4.1, Gemini 3.1 Flash Lite</li>
...
<ul>
  ...
  <li><b>AI Engine:</b> Gemini 3.1 Flash Lite (멀티모달 이미징 분석 및 JSON 구조화)</li>
...
<ul>
  ...
  <li><b>해결:</b> <code>Gemini 3.1</code>의 JSON Mode를 강제하고, Laravel의 유효성 검사(Validator)를 통한 데이터 2차 정제 로직 구현.</li>
</ul>
